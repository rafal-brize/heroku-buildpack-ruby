...
module LanguagePack
  ...
  def self.detect(*args)
    ...
    pack = [ NoLockfile, NoNextLockfile, Rails7, Rails6, Rails5, Rails42, Rails41, Rails4, Rails3, Rails2, Rack, Ruby ].detect do |klass|
      klass.use?
    end
...
require "language_pack/no_next_lockfile"
